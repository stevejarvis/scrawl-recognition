...
/**
 * An activity representing a list of Screens. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link ScreenDetailActivity} representing item details. On tablets, the
 ...
 */
public class ScreenListActivity extends FragmentActivity implements
		ScreenListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.screen_detail_container) != null) {
			...
			((ScreenListFragment) getSupportFragmentManager().findFragmentById(
					R.id.screen_list)).setActivateOnItemClick(true);
		}
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.screen_detail_container, fragment).commit();
